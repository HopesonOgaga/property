...
const Index = () => {
  ...
  return (
    <>
      <section className="relative bg-[#F5F2EC] text-[#2B2B2B]">
        ...
        <section className="relative flex flex-col md:flex-row items-center h-screen overflow-hidden">
          ...
          {/* TEXT */}
          <div className="relative z-10 w-full md:w-1/2 flex flex-col justify-center md:mt-0 mt-14 gap-6 p-6 md:p-12 text-white mix-blend-difference">
            <p className="text-4xl md:text-6xl font-semibold tracking-tight">
              Developing landmarks for tomorrow.
            </p>

            <p className="text-2xl md:text-3xl md:opacity-90 ">
        ...
        <section className="py-16 px-4 md:px-10 flex flex-col md:flex-row items-center md:items-start justify-center gap-10 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col gap-6 w-full md:w-2/5 text-base md:text-lg leading-relaxed">
            ...
            <p>
              With trust, expertise and strong financial foundations, AT Property
              Development continues shaping a better future—one landmark at a time.
            </p>
